...
import lombok.Data;
import vip.chentianxiang.mybatis.datasource.unpooled.UnpooledDataSource;
        ...
        synchronized (state) {
            ...
            if (connection.isValid()) {
                ...
                if (state.idleConnections.size() < poolMaximumIdleConnections && connection.getConnectionTypeCode() == expectedConnectionTypeCode) {
                    ...
                    logger.info("Returned connection" + newConnection.getHashCode() + " to pool");
