package vip.chentianxiang.builder.xml;

import org.dom4j.Document;
import org.dom4j.DocumentException;
import org.dom4j.Element;
import org.xml.sax.InputSource;
import vip.chentianxiang.builder.BaseBuilder;
...
/**
 * @PROJECT_NAME: XML配置构建器，建造者模式，继承BaseBuilder
 * @USER: TrueNewBee
 * @DATE: 2022/11/18 15:21
 * @DESCRIPTION: 用于解析XML,并把相应信息提取并放到 confine中,方便后续调用
 */
