...
import vip.chentianxiang.mybatis.reflection.wrapper.*;
 ...
 * 之后提供了一些基本的操作封装，这回封装后就更贴近实际的使用了。
 */
public class MetaObject {
    ...
    // 查找属性
    public String finProperty(String propName, boolean userCamelCaseMapping){
        return objectWrapper.findProperty(propName,userCamelCaseMapping);
    }
    ...
    public ObjectWrapper getObjectWrapper(){ return  objectWrapper;}
